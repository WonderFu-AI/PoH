...
function Chat({
  ...
  async function handleSend(): Promise<void> {
    ...
    setIsLoading(true);
    // Capture and clear attachment before async send
    ...
    if (!text) {
      ...
      try {
        ...
        // Error already handled by onChatError IPC listener
      }
      return;
    }
    setMessages((prev) => [
        ...
        <div className="chat-header-left">
          <div className="chat-header-title">
            {sessionId
              ...
              : sessionStartedAt
                ? new Date(sessionStartedAt).toLocaleDateString([], { month: "short", day: "numeric" }) + " " + new Date(sessionStartedAt).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })
                : "New Chat"}
          </div>
        </div>
