export default {
  ...
  fastModeOn: "Priority processing active — lower latency on supported models. Click to disable.",
  fastModeOff: "Enable priority processing for lower latency on OpenAI and Anthropic models.",
} as const;
